...
*// Messaged used
    CONSTANTS:
      ...
      no_single_id      TYPE scx_attrname VALUE 'Product id is requered to access the data'.
...
*.. Logic to get to the 'TITLE' in the response
...
*.. Logic to get to the 'PRODUCTVALUE' and 'CURRENCYCODE' in the response
    FIELD-SYMBOLS:  <ls_data>  TYPE any.
    ASSIGN io_data->* TO FIELD-SYMBOL(<lfs_data>).
    IF <lfs_data> IS ASSIGNED.
